...
To use these stylesheets, rename the files and rs_omega with the name of your theme.
...
rs_omega-alpha-default-narrow.css  
...
rs_omega-alpha-default-normal.css
...
rs_omega-alpha-default-wide.css
